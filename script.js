function gameStart() {
  ...
  for (let k = 0; k < inneransbox.length; k++) {
    inneransbox[k].addEventListener("touchstart", hell);
    document.getElementById("twos").addEventListener("touchstart", function () {
      check.checked = true;
    });
    function hell() {
...
function com(ans) {
  ...
  coms.addEventListener("click", function () {
    ...
    for (i = 0; i < cominneransbox.length; i++) {
      ...
      cominneransbox[i].addEventListener("touchstart", function () {
...
function fiftys(ans) {
  ...
  five.addEventListener("touchstart", function (e) {
...
function computers(ans) {
  ...
  _cominters.addEventListener("touchstart", function (e) {
...
function twenty(ans) {
  ...
  two.addEventListener("touchstart", function () {
    ...
    for (let i = 0; i < _child.length; i++) {
      ...
      _child[i].addEventListener("touchstart", function () {
        count += 1;
